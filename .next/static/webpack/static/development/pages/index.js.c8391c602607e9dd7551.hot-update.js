...
const Myradio = () => {
  ...
  const artist = store == 'first' ? data[0] : store == 'second' ? data[2] : data[3]; // const [value, setValue] = useState('female');
...
//# sourceMappingURL=index.js.c8391c602607e9dd7551.hot-update.js.map